...
| Released sound fix | [0.4.0 (6)](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/78bbc76a-16b3-4ef5-9319-a5937d0fa561), source `73d469cf6f52959e709be59367e982cb26ccbe36`; production build **FINISHED** September 23 at 1:19 PM EDT. EAS submission [ce7a8b9a-11c5-4bc4-97ec-edf2fc42ca28](https://expo.dev/accounts/geraldogs-team/projects/crewroom/submissions/ce7a8b9a-11c5-4bc4-97ec-edf2fc42ca28) **Succeeded**, observed around 2:51 PM EDT. The [Expo workflow](https://expo.dev/accounts/geraldogs-team/projects/crewroom/workflows/01a0cf48-f41c-717b-bd83-12539fc36ebe#job-01a0cf48-f41c-79dc-87d6-63cd2309d473) displayed duration 1h13m22s. Apple records upload at 2:34 PM EDT and processing **Complete**. Build 6 is **Testing** in the existing group. Automatic EAS TestFlight setup was disabled; group setup was completed separately in App Store Connect. |
...
| Previous store build | [0.4.0 (5)](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/dc9b03e3-d48f-400b-8c10-516db9c43b91), source `e7538730a5fb0924a540b410bff30a5b422a716c`; **FINISHED**. Remains Testing alongside sound-fix build 6. |
...
| Previous EAS submission | Build 5: [42060c69-ac89-45ce-a06b-bb5702a1a036](https://expo.dev/accounts/geraldogs-team/projects/crewroom/submissions/42060c69-ac89-45ce-a06b-bb5702a1a036) **FINISHED** at `2026-09-23T03:56:20Z`; Apple showed Processing at 11:56 PM EDT. |
| Apple beta review and distribution | Build 6 Apple UUID `a8fee7ee-2095-4bcf-a80a-5d57f4965e47`: processing **Complete**; added to Crewroom Private Beta, group `858d3c31-fabf-41d3-8b80-50eff303d459`. **Submit for Review** completed with **Automatically notify testers** checked. The group page immediately showed build 6 **Testing**, verified around 2:51 PM EDT. No separate manual Notify action was required; delivery/receipt is unverified. |
| Previous Apple beta review | Build 5 UUID `7e6b3fd3-3a3d-4c44-93ef-11431f991507`: upload Complete; Approved at 11:55 AM EDT, then observed **Testing** around 1:16 PM EDT in Crewroom Private Beta (5 testers). |
| Existing TestFlight | 0.4.0 (6), 0.4.0 (5) and 0.3.0 (2) are **Testing** in Crewroom Private Beta: 5 testers and 3 builds. Existing testers and invitation-link setting were preserved. Katherine’s corrected entry had shown Invited September 23; no tester was re-added or invitation resent by this update. |
...
| App Store Connect metadata/privacy | Beta Description, Review Notes and privacy URL `https://joincrewroom.com/privacy` remain saved. Build-6 What to Test was saved; the disabled **Saved** control confirmed persistence. Existing private review credentials were preserved. Collection categories below remain a draft proposal, not saved/published answers. |
...
## Build 5 What to Test summary (previously saved in App Store Connect)
...
## Build 6 What to Test (saved in App Store Connect)
...
The Beta Description, Review Notes and build-specific What to Test for builds 5 and 6 are saved in App Store Connect. The text below records the review context; the exact saved fields remain the source of truth. Build 6 uses the sound-fix notes above. Existing private review credentials were preserved.
...
1. **Completed:** Expo submission succeeded; Apple records build-6 upload at 2:34 PM EDT and processing Complete. Build-6 What to Test is saved. Preview 7 from the same native source passed the owner-reported swipe sound and leave-feed checks; TypeScript, existing native tests and native exports also passed.
2. **Completed:** build 6 was added to the existing Crewroom Private Beta group and submitted with automatic tester notification selected. Around 2:51 PM EDT the group page showed all three existing/replacement builds **Testing**, with 5 testers. No separate manual notification was required; notification receipt is not established.
3. **Preserved:** the existing audience, including Katherine’s corrected entry (`rijokatherine511@gmail.com`), older builds and invitation-link setting. No permissions or public App Store release were changed.
4. **Remaining device follow-up:** install build 6 through TestFlight and confirm launch/sign-in as a final store-signed installation check. Record device/OS if provided. This result and the broader physical checklist remain unverified.
