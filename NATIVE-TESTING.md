...
**Current store candidate: 0.4.0 (5).** Its [signed build](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/dc9b03e3-d48f-400b-8c10-516db9c43b91) and EAS submission finished; Apple processing is Complete and the build is **Waiting for Review** as of September 23, 12:06 AM EDT. It is submitted for the existing beta group with automatic notification disabled pending the final device check. The [preview 0.4.0 (4)](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/3239cd1b-a202-4506-8453-23adb4b1099b) was physically tested by the owner for cellular sign-in, a short recording/preview with sound, private-draft persistence and playback/seeking after restart, and audio stopping on leaving playback. Model/OS details and the remaining checklist, including public-video feed acceptance, are unverified.

Backend `7e3d78d` is Live with automatic photo/text screening and human video review; see [HYBRID-MODERATION.md](HYBRID-MODERATION.md) for operator instructions. Live private-video API checks passed 6/6 with both fixture accounts deleted and no public posts created. An isolated R2 MP4/poster round trip and a fresh production backup/restore with 11 images, 4 videos and 4 posters passed. Beta review metadata and the privacy URL are saved; privacy collection categories, Apple review and new tester availability remain pending. The existing TestFlight 0.3.0 (2) has not been replaced.
