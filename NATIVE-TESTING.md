...
For the September 22 native video update, follow [TESTFLIGHT-0.4.0.md](TESTFLIGHT-0.4.0.md) for historical video/sound-fix release evidence and [VIDEO-BETA.md](VIDEO-BETA.md) for the full acceptance checklist. Camera, microphone, video playback and hybrid moderation supersede the photo-only scope below. The September 18 results are historical and do not validate the new video behavior.

**Historical sound-fix release:** store 0.4.0 (6) was **Testing**, verified September 23 around 2:51 PM EDT in Crewroom Private Beta (5 testers, 3 builds). Expo submission succeeded; Apple records upload at 2:34 PM EDT and processing Complete. Build-6 What to Test is saved, and group submission completed with automatic tester notification selected. No separate manual notification was required; notification receipt is unverified. Store 6 and preview 7 share source `73d469c`. The owner reported the preview-7 checks passing: unmute and swipe forward/back, mute and swipe again, and leave the feed with audio stopping. Device/OS were not supplied; store-6 installation has not been confirmed. The release follow-up is stopped. See [the sound-fix release record](TESTFLIGHT-0.4.0.md) for links and results.

**Historical availability snapshot at the build-6 release:** 0.4.0 (5) and 0.3.0 (2) remain **Testing** alongside build 6. The [signed build 5](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/dc9b03e3-d48f-400b-8c10-516db9c43b91) was Approved September 23 at 11:55 AM EDT and observed Testing around 1:16 PM EDT. Katherine’s corrected entry had shown Invited September 23; existing testers and the invitation-link setting were preserved. Preview 0.4.0 (4) previously passed owner-reported cellular sign-in, recording/preview with sound, private-draft persistence/playback/seeking after restart and audio stopping on leaving playback. The owner subsequently confirmed public Videos playback and camera cancellation in the existing 0.4 iPhone app; that installed build, model and OS were not reconfirmed. The subsequently reported feed mute reset is addressed by build 6, with the requested preview-7 swipe sound and leave-feed checks passed by owner report.

TypeScript, 12/12 existing native-configuration/video-selection tests and iOS/Android exports passed for the sound-fix source. These automated checks are separate from the owner-reported preview-7 sound results above and do not establish store-6 installation acceptance. Backend `7e3d78d` is Live with automatic photo/text screening and human video review; see [HYBRID-MODERATION.md](HYBRID-MODERATION.md) for operator instructions. Live private-video API checks passed 6/6 with both fixture accounts deleted and no public posts created. An isolated R2 MP4/poster round trip and a fresh production backup/restore with 11 images, 4 videos and 4 posters passed. Beta review metadata and the privacy URL are saved; replacement-build distribution is complete. Privacy collection categories remain proposed, and store-6 installation and the broader physical checklist remain unverified.
