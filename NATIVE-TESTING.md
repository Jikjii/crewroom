...
**Current TestFlight: 0.4.0 (5) is Testing.** The [signed build](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/dc9b03e3-d48f-400b-8c10-516db9c43b91) was Approved at September 23, 11:55 AM EDT and later observed Testing around 1:16 PM EDT in Crewroom Private Beta (5 testers). Katherine’s corrected entry shows Invited September 23. Preview 0.4.0 (4) previously passed owner-reported cellular sign-in, recording/preview with sound, private-draft persistence/playback/seeking after restart and audio stopping on leaving playback. The owner subsequently confirmed public Videos playback and camera cancellation in the existing 0.4 iPhone app; that installed build, model and OS were not reconfirmed. A feed mute reset was also reported. The signed sound-fix candidates are ready, and the owner subsequently reported the requested preview-7 swipe sound and leave-feed checks passing.

TypeScript, 12/12 existing native-configuration/video-selection tests and iOS/Android exports passed for the sound-fix source. These automated checks are separate from the owner-reported preview-7 sound results above and do not establish store-6 installation acceptance. Backend `7e3d78d` is Live with automatic photo/text screening and human video review; see [HYBRID-MODERATION.md](HYBRID-MODERATION.md) for operator instructions. Live private-video API checks passed 6/6 with both fixture accounts deleted and no public posts created. An isolated R2 MP4/poster round trip and a fresh production backup/restore with 11 images, 4 videos and 4 posters passed. Beta review metadata and the privacy URL are saved; privacy collection categories and replacement-build distribution remain pending. TestFlight 0.3.0 (2) also remains Testing.
