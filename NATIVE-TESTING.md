...
**Current candidate: 0.4.0 (3).** The [signed iPhone preview](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/f7f2b4d4-a3e3-4558-b8da-6f1ba712e0b1) is ready for installation on the owner's registered iPhone. Open that page in iPhone Safari and choose **Install**. Its supporting backend is live at revision `c1be38b`. Physical video testing remains pending, and the existing TestFlight 0.3.0 (2) has not been replaced.
