...
export function PublicPageContent({ page, config, onOpen, children }: {
  ...
  return <View style={{ gap: 24 }}>
    ...
    {page === "privacy" ? <>
      ...
      {section("What other people can see", "Profiles start private. Publishing a profile and posts makes that content available to people without an account and it may be indexed or copied. Comments and credits on public posts are public. Shared crews, tasks, lineup and day plans are available to crew members. Collaboration requests are visible to the people involved; accepting one creates a new private shared crew. Your account email and password are not published on your profile.")}
