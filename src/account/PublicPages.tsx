...
export function PublicPageContent({ page, config, onOpen, children }: {
  ...
  return <View style={{ gap: 24 }}>
    ...
    {page === "privacy" ? <>
      ...
      {section("Hosting and email", "Our hosting provider processes the service’s database, photos, and operational traffic. When enabled, our email provider processes your email address to deliver password-reset links and requested beta confirmation emails. Launch updates require a separate opt-in. We use IP addresses and hashed email addresses for abuse rate limits. Hosting providers may keep their own access and security logs. Access to administrative tools is restricted to the operator.")}
