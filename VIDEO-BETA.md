...
**Historical video/sound-fix evidence, September 23, 2026 EDT.** The interface refresh, video backend and hybrid photo/text moderation are deployed. On signed iPhone preview **0.4.0 (4)**, the owner confirmed cellular sign-in, a 10–15 second recording and preview with sound, private-draft persistence and playback/seeking after restarting the app, and audio stopping when leaving playback. On September 23, the owner also confirmed approved public-video playback and camera cancellation leaving Create usable in the existing 0.4 iPhone app; the installed build for those later checks was not reconfirmed. The iPhone model and iOS version were not provided; the wider physical checklist below remains unverified.

**Historical sound-fix release:** store **0.4.0 (6) was Testing**, verified September 23 around 2:51 PM EDT in Crewroom Private Beta (5 testers, 3 builds). Expo submission succeeded; Apple records upload at 2:34 PM EDT and processing Complete. Build-6 What to Test is saved, and group submission completed with **Automatically notify testers** selected. No separate manual notification was required; notification receipt is unverified. The release follow-up is stopped. Store 6 and preview 7 share source `73d469c`; the owner reported the requested preview-7 checks passing: unmute and swipe forward/back, mute and swipe again, and leave the feed with audio stopping. Device/OS were not supplied; store-6 installation has not been confirmed. See [the sound-fix release record](TESTFLIGHT-0.4.0.md) for links and results.

Previous App Store distribution **0.4.0 (5)** finished from source `e753873`, and its EAS submission succeeded at `2026-09-23T03:56:20Z`. Apple processing completed; build 5 was **Approved** September 23 at 11:55 AM EDT and observed **Testing** around 1:16 PM EDT. Builds 5 and 0.3.0 (2) remain Testing alongside build 6; existing testers and the invitation-link setting were preserved. Katherine’s corrected entry had shown Invited September 23. Build 6 addresses the owner's report that every feed video resets to muted. The fix keeps the sound preference across clips while the feed stays open; closing/reopening starts muted again. TypeScript, 12/12 native-configuration/video-selection tests and iOS/Android exports passed; the owner subsequently reported the requested preview-7 sound checks passing. No automated component sound test is recorded. Follow [TESTFLIGHT-0.4.0.md](TESTFLIGHT-0.4.0.md) for the historical video/sound-fix release record; [preview build 4](https://expo.dev/accounts/geraldogs-team/projects/crewroom/builds/3239cd1b-a202-4506-8453-23adb4b1099b) established the earlier device results, and preview build 7 established the owner-reported sound-fix checks.
...
**September 23 follow-up, existing 0.4 iPhone app (installed build not reconfirmed):** approved public video plays in Videos, and canceling the camera leaves Create usable. The owner also reported mute resetting on each new feed video.

**September 23 sound-fix follow-up, requested preview 0.4.0 (7):** the owner replied “everything is working” to unmute → swipe forward/back, mute → swipe again, and leave the feed → audio stops. Record these as owner-reported passes, not instrumented results. Device model and iOS version were not supplied. Store-build-6 installation, background/lock behavior, reopening behavior and the rest of the matrix are not established by this reply.
...
- September 23: owner confirmed public Videos playback and camera cancellation in the existing 0.4 iPhone app, and reported mute resetting on each feed clip. Source now preserves the open feed's sound preference. TypeScript, 12/12 configuration/selection tests and iOS/Android exports passed; the owner subsequently reported the requested preview-7 swipe sound and leave-feed checks passing. No automated component sound test is recorded.
- September 23: signed sound-fix store build 6 and preview build 7 finished from `73d469c`. The owner reported the requested preview-7 swipe sound and leave-feed checks passing.
- September 23, around 2:51 PM EDT: EAS submission `ce7a8b9a-11c5-4bc4-97ec-edf2fc42ca28` observed **Succeeded** (workflow duration 1h13m22s). Apple records build-6 upload at 2:34 PM EDT and processing **Complete**, UUID `a8fee7ee-2095-4bcf-a80a-5d57f4965e47`. Exact prepared What to Test saved. Build 6 was added to the existing Crewroom Private Beta group and submitted with automatic tester notification selected. The group page immediately showed **0.4.0 (6) Testing**, alongside builds 5 and 2, with 5 testers and 3 builds. No separate manual notification was required; receipt is unverified. Existing audience, older builds, invitation-link setting and private credentials were preserved. The release follow-up was stopped after completion.
- Still pending: store-6 installation acceptance. Broader permission/media/report/block checks and final App Privacy answers remain separately unverified.

| Historical video/sound-fix release evidence | Result |
|---|---|
| Source revision and automated checks | Video implementation `c1be38b`: 95/95 tests, TypeScript, Expo Doctor 21/21 and web/iOS/Android exports. Moderation follow-up: 60/60 targeted tests and 8/8 live provider cases. Sound-fix source `73d469c`: TypeScript, 12/12 existing configuration/selection tests and iOS/Android exports passed. Sound-fix store build 6 and preview 7 share `73d469c`; previous store build 5 used `e753873`. |
...
| Signed iPhone build and installation | Ad hoc 0.4.0 (4) installed and exercised by owner. Requested preview 0.4.0 (7) sound checks passed by owner report. Store 0.4.0 (6) upload succeeded, Apple processing Complete, and Testing verified around 2:51 PM EDT September 23. Store-6 installation remains unverified. |
| Physical iPhone checklist | Owner-reported cellular sign-in, recording with sound, private-draft persistence/playback/seeking, audio stop, approved public-video playback and camera cancellation passed. The replacement preview-7 swipe sound and leave-feed checks also passed by owner report. Device/OS details and the broader matrix remain unverified. |
| App Store Connect privacy/review update | Beta Description, Review Notes and privacy URL saved. Build-6 What to Test saved; disabled Saved control confirmed persistence. Existing private review credentials preserved. Data-collection categories remain proposed. |
| TestFlight build/status | 0.4.0 (6), 0.4.0 (5) and 0.3.0 (2) Testing, verified around 2:51 PM EDT September 23 in Crewroom Private Beta (5 testers, 3 builds). Automatic tester notification selected for build 6; delivery/receipt unverified. Existing testers and invitation-link setting unchanged. |

- September 23, 12:06 AM EDT (historical): Apple upload processing Complete; build 5 submitted for Crewroom Private Beta (4 testers), **Waiting for Review**. What to Test saved. Automatic notification was disabled while public-video/camera-cancel confirmation was then pending. The live public feed returned two approved videos and anonymous MP4 range requests returned HTTP 206. See the historical distribution record in [TESTFLIGHT-0.4.0.md](TESTFLIGHT-0.4.0.md).
