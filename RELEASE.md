...
**Current release work:** see [TESTFLIGHT-0.4.0.md](TESTFLIGHT-0.4.0.md) for the video/hybrid-moderation iPhone beta. Build 0.4.0 (5) was Approved September 23 at 11:55 AM EDT and observed **Testing** around 1:16 PM EDT. The owner confirmed public-video playback and camera cancellation in the existing 0.4 iPhone app, then reported the feed resetting each video to muted. The sound fix carries the preference across the open feed. Signed preview 0.4.0 (7) passed the owner-reported swipe sound and leave-feed checks on September 23; store 0.4.0 (6) remains queued for Apple upload as of around 1:30 PM EDT and is not yet listed in App Store Connect. The 0.3 status below is a **historical snapshot from September 18, 2026**; its Apple review/tester status is not the current release status.
